...
const SchedulePage = ({meet, date, name, openModal}) => {
    return (
            <div className={`w-[64%] absolute z-[100] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 my-auto h-[80%] bg-white rounded-md flex ${openModal ? 'flex' : 'hidden'}`}>
                <div className='w-1/2 flex flex-col items-center mx-auto py-8 h-full'>
                    ...
                    <p className='mt-4 text-sm'>A calendar invitation has been sent to your email address</p>
